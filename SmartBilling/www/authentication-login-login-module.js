...
var FaIconService = /** @class */ (function () {
    ...
    /** @nocollapse */ FaIconService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["defineInjectable"])({ factory: function FaIconService_Factory() { return new FaIconService(); }, token: FaIconService, providedIn: "root" });
...
/* harmony import */ var _login_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./login.page */ "./src/app/authentication/login/login.page.ts");
...
/***/ "./src/app/authentication/login/login.page.html":
/*!******************************************************!*\
  !*** ./src/app/authentication/login/login.page.html ***!
  \******************************************************/
...
module.exports = "<ion-header>\n    <ion-toolbar color=primary>\n      <ion-title >Smart Billing\n      </ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content>  \n    <ion-card style=\"margin-top: 1cm\"> \n      <form [formGroup]=\"loginForm\" (ngSubmit)=\"onSubmit()\">\n          <ion-item>\n              <ion-card-title color=\"primary\" >{{login}}</ion-card-title>\n              <ion-icon (click)=\"onClick()\" *ngIf=dis  name=\"person-add\" slot=\"end\"></ion-icon>\n              <ion-icon (click)=\"onClick()\" style=\"margin-left:auto\" *ngIf=dis2  name=\"arrow-round-back\"></ion-icon>\n          </ion-item>\n          <div *ngIf=dis>\n            <ion-card>\n              <ion-item>\n                  <ion-input type=\"text\" placeholder=\"Email\" formControlName=\"email\"></ion-input>\n              </ion-item>\n            </ion-card>\n            <ion-card>\n              <ion-item>\n                <ion-input type=\"password\"  placeholder=\"Password\" formControlName=\"password\"></ion-input>\n              </ion-item>\n            </ion-card>\n            <ion-button type=\"submit\"  size=\"small\"  color=\"tertiary\"  style=\"margin:auto; margin-bottom: 20px;margin-left:6cm\"  padding>{{login}}</ion-button>\n          </div> \n          <div *ngIf=dis2>\n              <ion-card>\n              <ion-item>\n                  <ion-input type=\"text\" placeholder=\"Shop Name *\" formControlName=\"name\"></ion-input>\n              </ion-item>\n              </ion-card>\n              <ion-card>\n              <ion-item>\n                  <ion-input type=\"text\" placeholder=\"Streat *\" formControlName=\"streat\"></ion-input>\n              </ion-item>\n              </ion-card> \n              <ion-card>\n              <ion-item>\n                  <ion-input type=\"text\" placeholder=\"City *\" formControlName=\"city\"></ion-input>\n              </ion-item>\n              </ion-card>\n              <ion-card>\n              <ion-item>\n                  <ion-input type=\"text\" placeholder=\"Email\" formControlName=\"email\"></ion-input>\n              </ion-item>\n              </ion-card>\n              <ion-card>\n              <ion-item>\n                <ion-input type=\"password\"  placeholder=\"Password\" formControlName=\"password\"></ion-input>\n              </ion-item>\n              </ion-card> \n                <ion-button (click)=\"onRegister()\"  size=\"small\"  color=\"tertiary\"  style=\"margin:auto; margin-bottom: 20px;margin-left:5cm\"  padding>{{login}}</ion-button>\n            </div>  \n            <div *ngIf='!set'>\n              <label (click)=\"onChange()\">Forget Password?</label>\n            </div>\n            <div *ngIf='set'>\n              <ion-card>\n                <ion-item>\n                    <ion-input type=\"text\" placeholder=\"Enter Registerd Email\" formControlName=\"resetEmail\"></ion-input>\n                </ion-item>\n              </ion-card>\n              <ion-button (click)=\"onSend()\"  size=\"small\"  color=\"tertiary\"  style=\"margin:auto; margin-bottom: 20px;margin-left:6cm\"  padding>Reset</ion-button>\n            </div>\n    </form>\n</ion-card>\n</ion-content>\n"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2F1dGhlbnRpY2F0aW9uL2xvZ2luL2xvZ2luLnBhZ2Uuc2NzcyJ9 */"
...
var LoginPage = /** @class */ (function () {
    ...
    function LoginPage(menuCtrl, fb, http, router, toastController) {
    ...
    LoginPage.prototype.onSubmit = function () {
        ...
        this.http.loginUser(inputdata).subscribe(function (res) {
    ...
    LoginPage.prototype.presentAlertMultipleButtons = function () {
    ...
    LoginPage.prototype.onRegister = function () {
        ...
        var streat = this.loginForm.get('streat').value;
        var city = this.loginForm.get('city').value;
        var inputdata = new FormData();
        inputdata.append('email', email);
        inputdata.append('password', password);
        ...
        this.http.registerUser(inputdata).subscribe(function (res) {
            console.log(res);
            _this.dis = true;
            _this.dis2 = false;
            _this.login = 'Login';
    ...
    LoginPage.prototype.onSend = function () {
        var _this = this;
        var email2 = this.loginForm.get('resetEmail').value;
        var data = {
            email: email2
        };
        localStorage.setItem('email', email2);
        this.http.reset(data).subscribe(function (response) {
            console.log(response);
            _this.set = false;
            _this.resetToast();
            _this.router.navigate(['../register/' + response.OTP]);
        });
    };
    LoginPage.prototype.resetToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alertcntrl;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-login',
            template: __webpack_require__(/*! ./login.page.html */ "./src/app/authentication/login/login.page.html"),
            styles: [__webpack_require__(/*! ./login.page.scss */ "./src/app/authentication/login/login.page.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["MenuController"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], src_app_shared_http_service__WEBPACK_IMPORTED_MODULE_5__["HttpService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"]])
    ], LoginPage);
    return LoginPage;
}());
...
//# sourceMappingURL=authentication-login-login-module.js.map